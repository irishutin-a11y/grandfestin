...
window.FESTIN_DATA.projetPages = {
  ...
  "tournesol": {
    ...
    soutien: { text: "Les cours ont lieu au centre Corot Formation, à Marseille ; AFC Groupe assure la formation technique." },
    galerieRff: true,
  ...
  "la-table-de-cana": {
    ...
    soutien: { title: "Soutenir", accent: "La Table de Cana",
      text: "En 2025, MediaPerformances est devenu financeur de l'aide alimentaire." },
