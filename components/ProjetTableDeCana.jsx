...
function ProjetTableDeCanaPage() {
  ...
  return (
    <div className="pageProjet pageProjet--la-table-de-cana" ref={rootRef} data-screen-label={"Projet — " + p.shortTitle}>
      ...
      {/* HERO */}
      <window.HeroPage tone="teal" kicker={p.eyebrow + " · Marseille · un projet de l’association Festin"} title={p.title} accent={p.accent} proof={p.projetPhrase}
        img={p.heroImages[0]} imgAlt="Cuisine de La Table de Cana à Marseille" logo={p.logo} logoAlt={"Logo " + p.shortTitle}>
